...
var React = _interopRequireWildcard(__webpack_require__(6002));
...
var _scrollHandler = __webpack_require__(3215);
var _react = __webpack_require__(6002);
...
var _react = _interopRequireDefault(__webpack_require__(6002));
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 125).then(__webpack_require__.bind(__webpack_require__, 3331)),"component---src-pages-about-js":()=>__webpack_require__.e(/* import() | component---src-pages-about-js */ 432).then(__webpack_require__.bind(__webpack_require__, 9434)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 293).then(__webpack_require__.bind(__webpack_require__, 8288)),"component---src-pages-portfolio-js":()=>__webpack_require__.e(/* import() | component---src-pages-portfolio-js */ 821).then(__webpack_require__.bind(__webpack_require__, 4163)),"component---src-pages-portfolio-mdx-frontmatter-slug-js-content-file-path-portfolio-jazz-flirt-festival-mdx":()=>__webpack_require__.e(/* import() | component---src-pages-portfolio-mdx-frontmatter-slug-js-content-file-path-portfolio-jazz-flirt-festival-mdx */ 101).then(__webpack_require__.bind(__webpack_require__, 9185)),"component---src-pages-portfolio-mdx-frontmatter-slug-js-content-file-path-portfolio-jazz-flirt-website-mdx":()=>__webpack_require__.e(/* import() | component---src-pages-portfolio-mdx-frontmatter-slug-js-content-file-path-portfolio-jazz-flirt-website-mdx */ 952).then(__webpack_require__.bind(__webpack_require__, 3784)),"component---src-pages-portfolio-mdx-frontmatter-slug-js-content-file-path-portfolio-masseria-raino-mdx":()=>__webpack_require__.e(/* import() | component---src-pages-portfolio-mdx-frontmatter-slug-js-content-file-path-portfolio-masseria-raino-mdx */ 732).then(__webpack_require__.bind(__webpack_require__, 65))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-styled-components',plugin:__webpack_require__(3203),options:{"plugins":[],"displayName":true,"fileName":true,"minify":true,"namespace":"","transpileTemplateLiterals":true,"topLevelImportPaths":[],"pure":false,"disableVendorPrefixes":false}},{name:'gatsby-plugin-image',plugin:__webpack_require__(70),options:{"plugins":[]}},{name:'default-site-plugin',plugin:__webpack_require__(4382),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const getSliceId=(sliceName,sliceProps)=>{if(!Object.keys(sliceProps).length){return sliceName;}const propsString=createContentDigest(sliceProps);return`${sliceName}-${propsString}`;};const ServerSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesProps=(0,external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_.useContext)(context.SlicesPropsContext);const concreteSliceName=slicesMap[sliceName];if(!concreteSliceName){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}const sliceId=getSliceId(concreteSliceName,sliceProps);// set props on context object for static-entry to return
let sliceUsage=slicesProps[sliceId];if(!sliceUsage){slicesProps[sliceId]=sliceUsage={props:sliceProps,sliceName:concreteSliceName,hasChildren:!!children};}else{if(children){sliceUsage.hasChildren=true;}}return/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(server_slice_renderer.ServerSliceRenderer,{sliceId:sliceId},children);};
;// CONCATENATED MODULE: ./.cache/slice/inline-slice.js
const InlineSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesResultsMap=(0,external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_.useContext)(context.SlicesResultsContext);const concreteSliceName=slicesMap[sliceName];const slice=slicesResultsMap.get(concreteSliceName);if(!slice){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}return/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(slice.component,Object.assign({sliceContext:slice.sliceContext,data:slice.data},sliceProps),children);};
...
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
const fullStack=external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();// remove the first line of the stack trace
...
const React=__webpack_require__(6002);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9226);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(8286);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
const GlobalStyles=(0,styled_components_esm.createGlobalStyle)(["/ background:hsl(38.6,19.6%,42%);}::selection{background:hsl(38.6,19.6%,42%);}*::-webkit-scrollbar{width:8px;}*::-webkit-scrollbar-track{background:hsla(39,23%,25%,0);}*::-webkit-scrollbar-thumb{background-color:hsl(39,100%,64.1%);}body{overflow:hidden;}html{height:100vh;scrollbar-width:thin;scrollbar-color:hsl(39,100%,64.1%) hsla(39,23%,25%,0);background-color:hsl(38.8,48.6%,93.1%);opacity:1;background-image:radial-gradient(hsl(37.5,15.7%,20%) 0.5px,hsl(36.9,17.8%,14.3%) 0.5px);background-size:5px 5px;}ul{list-style:none;}"]);/* harmony default export */ const styles_GlobalStyles = (GlobalStyles);
;// CONCATENATED MODULE: ./src/styles/Typography.js
const Typography=(0,styled_components_esm.createGlobalStyle)(["body{font-family:\"Inconsolata\",monospace;-webkit-text-size-adjust:none;text-size-adjust:none;}html{font-size:1rem;}@media (max-width:840px){}@media (max-width:360px){}h1{font-size:clamp(1.8rem,1.4500rem + 0.6667vw,2.4rem)!important;margin:0;padding:0;color:hsl(37.7,100%,91.6%);font-weight:bold;}h2{font-size:clamp(1.4rem,1.2500rem + 0.6667vw,1.6rem)!important;margin:0;padding:0;color:hsla(38,22%,26%,1);}h3{font-size:clamp(1.2rem,1.0500rem + 0.6667vw,1.4rem)!important;margin:0;padding:0;color:hsla(38,22%,26%,1);}h4{font-size:clamp(1rem,0.8500rem + 0.6667vw,1.2rem)!important;margin:0;padding:0;}h5{font-size:clamp(0.8rem,0.6500rem + 0.6667vw,1rem)!important;margin:0;padding:0;}h6{font-size:clamp(0.8rem,0.9500rem + -0.6667vw,0.6rem)!important;margin:0;padding:0;}p{font-size:clamp(1.1rem,0.7500rem + 0.6667vw,1.3rem);}"]);/* harmony default export */ const styles_Typography = (Typography);
// EXTERNAL MODULE: ./.cache/gatsby-browser-entry.js + 11 modules
var gatsby_browser_entry = __webpack_require__(123);
;// CONCATENATED MODULE: ./src/components/Nav.js
const NavStyles=styled_components_esm["default"].nav.withConfig({displayName:"Nav__NavStyles",componentId:"sc-kql3wn-0"})(["grid-column:1/3;display:flex;flex-direction:row;position:sticky;top:0;width:100%;height:8vh;.menu{display:inline-flex;align-items:center;padding:0;margin:0 0.8% 0 2%;height:100%;width:100%;-webkit-transition:flex 1s ease-out;-moz-transition:flex 1s ease-out;-ms-transition:flex 1s ease-out;-o-transition:flex 1s ease-out;transition:flex 1s ease-out;a{text-decoration:none;margin-left:0;}}@media (max-width:520px){.menu{justify-content:space-evenly;}}"]);function Nav(){const linkStyles={background:'hsl(36.9, 33.3%, 69.4%)',color:'hsl(38.4, 95%,4%)',textTransform:'uppercase',width:'fit-content',height:'20px',textAlign:'center',fontSize:'clamp(1rem, 0.8500rem + 0.6667vw, 1.2rem)',padding:'0.6rem',margin:'0 0.5rem 0 0'};const activeStyles={background:'hsl(39, 100%, 64.1%)',color:'hsl(38.4, 95%,4%)'};return/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(NavStyles,null,/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement("ul",{className:"menu"},/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{style:linkStyles,activeStyle:activeStyles,to:"/"},"Home"),/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{style:linkStyles,activeStyle:activeStyles,to:"/portfolio"},"Portfolio"),/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{style:linkStyles,activeStyle:activeStyles,to:"/about"},"About me"),/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement("a",{style:linkStyles,activeStyle:activeStyles,href:"mailto:ivancernuto@gmail.com"},"@mail")));}
;// CONCATENATED MODULE: ./src/components/Layout.js
const GridStyled=styled_components_esm["default"].div.withConfig({displayName:"Layout__GridStyled",componentId:"sc-12re2ly-0"})(["height:100vh;width:100vw;display:grid;grid-template-columns:1fr;@media (max-width:450px){margin:0;}"]);function Layout({children}){return/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(GridStyled,null,/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(styles_Typography,null),/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(styles_GlobalStyles,null),/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(Nav,null),children);}
;// CONCATENATED MODULE: ./gatsby-ssr.js
function wrapPageElement({element,props}){return/*#__PURE__*/external_C_Users_Ivan_webdev_bisabi_node_modules_react_index_js_default().createElement(Layout,props,element);}
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var _react=_interopRequireDefault(__webpack_require__(6002));var _styledComponents=__webpack_require__(1864);var sheetByPathname=new Map();// eslint-disable-next-line react/prop-types,react/display-name
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(6002),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("C:\\Users\\Ivan\\webdev\\bisabi\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Users\\Ivan\\webdev\\bisabi\\node_modules\\react-dom\\server.js");
...
/******/ 			return "" + {"101":"component---src-pages-portfolio-mdx-frontmatter-slug-js-content-file-path-portfolio-jazz-flirt-festival-mdx","125":"component---src-pages-404-js","293":"component---src-pages-index-js","432":"component---src-pages-about-js","732":"component---src-pages-portfolio-mdx-frontmatter-slug-js-content-file-path-portfolio-masseria-raino-mdx","821":"component---src-pages-portfolio-js","952":"component---src-pages-portfolio-mdx-frontmatter-slug-js-content-file-path-portfolio-jazz-flirt-website-mdx"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(6002);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(8286);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(4057);const{WritableAsPromise}=__webpack_require__(7227);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(988);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
